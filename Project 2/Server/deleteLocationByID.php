<?php
	...
	$locations = "('" . implode("','", $_REQUEST['locations']) . "')";
	$query = $conn->prepare("SELECT * FROM department as d INNER JOIN location as l ON l.id = d.locationID WHERE l.id IN $locations ");
	$query->execute();
