...
;(function () {
  L.Control.NavBar = L.Control.extend({
    ...
    onAdd: function (map) {
      ...
      this._fwdButton = this._createButton(
        options.forwardTitle,
        controlName + '-fwd',
        container,
        this._goFwd,
      )
      ...
      this._viewHistory = [
        { center: this.options.center, zoom: this.options.zoom },
      ]
      this._curIndx = 0
    ...
    _updateHistory: function () {
      ...
      this._viewHistory.splice(
        insertIndx,
        this._viewHistory.length - insertIndx,
        newView,
      )
      this._curIndx++
